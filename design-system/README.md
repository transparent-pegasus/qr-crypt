...
For the current implementation and its contracts, see:

- [Source](../src/)
- [Tests](../tests/)
- [QR protocol specification](../docs/spec/qr-protocol-v2.md)
- [Boot and reset specification](../docs/spec/boot-and-reset-v2.md)
