...
export const LOCALES = {
  ja: {
    ...
    strings: {
      ...
      "seam.body1": "QR転送経路では、この境界を越えるのは光だけ——",
      "seam.body2":
        "片方の画面に表示されたQRコードを、もう片方のカメラで読み取る。リムーバブルメディアとシステムクリップボードは別の選択肢であり、アプリの管理外です。",
      ...
      "locks.eyebrow": "暗号方式",
      "locks.heading": "2つのモード",
      "locks.lede":
        "誰に宛てるか、相手に何を渡してよいかで選びます。",
      "locks.aes.name": "共有鍵モード",
      "locks.aes.when": "1対1のやり取り向け",
      "locks.aes.body":
        "対面で共有した秘密を使用してメッセージを暗号化します。データ量が小さく、少ないQRコードで送受信できます。暗号化ごとにHKDFで異なるAES-256-GCM鍵を導出します。",
      "locks.pq.name": "公開鍵モード",
      "locks.pq.when": "複数の送信者から1人の受信者へ送るとき",
      "locks.pq.body":
      ...
      "install.a.docUrl": "docs/locales/ja/develop/install-route-a/README.md",
      "install.a.docHref":
        "https://github.com/transparent-pegasus/qr-crypt/blob/main/docs/locales/ja/develop/install-route-a/README.md",
      "install.b.tag": "方法B",
